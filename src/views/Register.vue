			...
			<div class="wrap-login">
				...
				<div id="form"  class="login-form">
					...
					<div class="wrap-input">
						<input id="fullname" class="input" type="text" name="fname" placeholder="Name and Surname" v-model="fname">
						<span class="focus-input"></span>
						<span class="symbol-input">
							<img src="@/assets/name.png" style="width: 30px; height:30px; opacity:80%; margin-left:-5%;">
						</span>
					</div>
