<template>
  <NavBar />
    ...
    <div class="container">
        ...
        <nav class="main_nav">
            <ul class="nav_list">
                <li class="nav_list-item"><router-link class="nav_link" to="/gameview">Game List</router-link></li>
                <li class="nav_list-item"><router-link class="nav_link" to="/gamecreate">Add Games</router-link></li>
